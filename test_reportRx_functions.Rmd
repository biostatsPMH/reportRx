...
# This will select pander tables for Word documents and kable + kableExtra for pdf/html documents
if (knitr::pandoc_to("docx")) {options('doc_type'='doc')} else (options('doc_type'='pdf'))
